...
import { Menu, X, Shield, ChevronDown, FileText, Download } from 'lucide-react';
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-slate-800 rounded-lg mt-2 mb-4">
            <div className="px-4 py-2 space-y-3">
              ...
              <a href="/contact" className="block text-slate-200 hover:text-white py-2 transition-colors">
                Contact
              </a>
              <div className="pt-2">
                <a 
