...
const InformationSecurityPolicyPage = () => {
  ...
  // Get product data
  const product = getProduct('information-security-policy');
  const relatedProducts = getRelatedProducts('information-security-policy');
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Master information security policy establishing overall security program framework. Includes enterprise, SMB, implementation workbook, and quick reference guide.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Information Security Policy - Example Company</h3>
