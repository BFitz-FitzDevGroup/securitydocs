...
const SampleDisasterRecoveryTabletopExerciseTemplatePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('sample-disaster-recovery-tabletop-exercise-template');
  const relatedProducts = getRelatedProducts('sample-disaster-recovery-tabletop-exercise-template');
            ...
            <div className="mb-8">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed">
                  The Sample Disaster Recovery Tabletop Exercise provides essential documentation for demonstrating SOC 2 compliance. Business continuity and disaster recovery capabilities are essential SOC 2 requirements that demonstrate your organization can maintain operations during disruptions. Auditors will examine backup procedures, recovery time objectives, and evidence of regular testing. This template provides comprehensive guidance on backup strategies, recovery procedures, testing protocols, and documentation requirements. It addresses common audit findings around untested recovery procedures, inadequate backup verification, and missing recovery time objectives that can derail SOC 2 audits. This template includes the document template itself plus detailed usage instructions to ensure proper implementation. Both are professional Microsoft Word documents that you can immediately customize for your organization's specific needs and workflow requirements.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Sample Disaster Recovery Tabletop Exercise - Example Company</h3>
...
export default SampleDisasterRecoveryTabletopExerciseTemplatePage;
