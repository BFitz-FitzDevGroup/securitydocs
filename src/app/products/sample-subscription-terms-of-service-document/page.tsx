...
const SampleSubscriptionTermsOfServiceDocumentPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('sample-subscription-terms-of-service-document');
  const relatedProducts = getRelatedProducts('sample-subscription-terms-of-service-document');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Sample Subscription Terms of Service - Example Company</h3>
...
export default SampleSubscriptionTermsOfServiceDocumentPage;
