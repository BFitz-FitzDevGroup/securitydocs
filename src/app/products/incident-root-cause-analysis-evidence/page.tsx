...
const IncidentRootCauseAnalysisEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('incident-root-cause-analysis-evidence');
  const relatedProducts = getRelatedProducts('incident-root-cause-analysis-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed">
                  Understanding what auditors expect for this evidence requirement is crucial for SOC 2 success. This Incident Root Cause Analysis - Evidence Explanation clarifies exactly what documentation you need and how to present it effectively. Incident response capabilities are essential for SOC 2 compliance and demonstrate your organization's ability to detect, respond to, and recover from security events. Auditors will examine your incident response procedures, testing protocols, and evidence of regular plan reviews. This template provides a complete incident response framework including detection mechanisms, escalation procedures, communication protocols, and post-incident analysis requirements. It addresses common audit gaps around incident categorization, response timeframes, and stakeholder notification procedures that many organizations overlook during initial compliance efforts. This evidence explanation clarifies exactly what auditors are looking for, common mistakes to avoid, and best practices for presenting this evidence during your SOC 2 audit. It's designed to demystify audit requirements and give you confidence in your compliance preparation.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Incident Root Cause Analysis - Evidence Explanation - Example Company</h3>
...
export default IncidentRootCauseAnalysisEvidencePage;
