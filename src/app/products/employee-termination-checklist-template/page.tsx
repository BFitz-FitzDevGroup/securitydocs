...
const EmployeeTerminationChecklistTemplatePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('employee-termination-checklist-template');
  const relatedProducts = getRelatedProducts('employee-termination-checklist-template');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Employee Termination Checklist Template - Example Company</h3>
...
export default EmployeeTerminationChecklistTemplatePage;
