...
const Soc2SystemDescriptionEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('soc-2-system-description-evidence');
  const relatedProducts = getRelatedProducts('soc-2-system-description-evidence');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>All CC:</strong> SOC 2 Trust Service Criteria compliance requirement</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">SOC 2 System Description - Evidence Explanation - Example Company</h3>
...
export default Soc2SystemDescriptionEvidencePage;
