...
const AcceptableUseMonitoringEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('acceptable-use-monitoring-evidence');
  const relatedProducts = getRelatedProducts('acceptable-use-monitoring-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed">
                  Understanding what auditors expect for this evidence requirement is crucial for SOC 2 success. This Acceptable Use Monitoring - Evidence Explanation clarifies exactly what documentation you need and how to present it effectively. Security monitoring and logging are critical SOC 2 requirements that enable threat detection and incident response. Auditors will examine your logging configurations, log retention periods, and evidence of regular log review. This template provides comprehensive guidance on what to log, how long to retain logs, and procedures for log analysis. It addresses common audit gaps around incomplete logging coverage, inadequate log protection, and missing log review documentation that many organizations discover too late in the audit process. This evidence explanation clarifies exactly what auditors are looking for, common mistakes to avoid, and best practices for presenting this evidence during your SOC 2 audit. It's designed to demystify audit requirements and give you confidence in your compliance preparation.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC7.3:</strong> The entity evaluates security events to determine whether they could impact system operations</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Acceptable Use Monitoring - Evidence Explanation - Example Company</h3>
...
export default AcceptableUseMonitoringEvidencePage;
