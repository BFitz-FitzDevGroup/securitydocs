...
const PrivacyPolicyPage = () => {
  ...
  // Get product data
  const product = getProduct('privacy-policy');
  const relatedProducts = getRelatedProducts('privacy-policy');
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Comprehensive privacy policy for protecting personal information and meeting privacy requirements. Includes enterprise, SMB, implementation workbook, and quick reference guide.
              </p>
            </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>P2.1:</strong> The entity obtains consent for use of personal information</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Privacy Policy - Example Company</h3>
