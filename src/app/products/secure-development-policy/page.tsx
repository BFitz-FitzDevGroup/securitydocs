...
const SecureDevelopmentPolicyPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('secure-development-policy');
  const relatedProducts = getRelatedProducts('secure-development-policy');
            ...
            <div className="mb-8">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed">
                  The Secure Development Policy is a critical component of SOC 2 compliance that auditors will thoroughly review during your audit. SOC 2 compliance requires comprehensive documentation across multiple Trust Service Criteria. This template provides the professional framework auditors expect to see, addressing common audit findings and compliance gaps. It includes clear procedures, roles and responsibilities, and documentation requirements that demonstrate your commitment to security and compliance. Whether you're preparing for your first SOC 2 audit or maintaining ongoing compliance, this template gives you a solid foundation based on real-world audit experience. This policy includes four versions to fit your organization's needs: an Enterprise version for larger organizations with complex requirements, an SMB version optimized for smaller teams, an Implementation Workbook with step-by-step guidance, and a Quick Reference Guide for daily use. All versions are professionally formatted Microsoft Word documents ready for customization to your specific environment.
                </p>
              </div>
            </div>
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC7.1:</strong> The entity uses detection tools and procedures to identify anomalies</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC8.1:</strong> The entity authorizes, designs, develops, and tests changes to system components</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Secure Development Policy - Example Company</h3>
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-200">
                      ...
                      <div className="bg-white rounded p-4 border border-slate-200">
                        <ul className="space-y-2 text-slate-700 text-sm">
                          ...
                          <li className="flex items-start">
                            <span className="w-2 h-2 bg-slate-400 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                            <span>SOC 2 compliant structure</span>
                          </li>
                          <li className="flex items-start">
                            <span className="w-2 h-2 bg-slate-400 rounded-full mr-3 mt-2 flex-shrink-0"></span>
...
export default SecureDevelopmentPolicyPage;
