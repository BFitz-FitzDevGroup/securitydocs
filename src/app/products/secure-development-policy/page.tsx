          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Secure software development lifecycle policy with coding standards and testing requirements. Includes enterprise, SMB, implementation workbook, and quick reference guide.
              </p>
            </div>
