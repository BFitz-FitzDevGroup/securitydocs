          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Policy for managing hardware, software, and data assets throughout their lifecycle. Includes enterprise, SMB, implementation workbook, and quick reference guide.
              </p>
            </div>
