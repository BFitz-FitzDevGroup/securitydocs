...
const AssetManagementPolicyPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('asset-management-policy');
  const relatedProducts = getRelatedProducts('asset-management-policy');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC6.5:</strong> The entity discontinues access when no longer required</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Asset Management Policy - Example Company</h3>
...
export default AssetManagementPolicyPage;
