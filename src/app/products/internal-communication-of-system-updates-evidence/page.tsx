...
const InternalCommunicationOfSystemUpdatesEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('internal-communication-of-system-updates-evidence');
  const relatedProducts = getRelatedProducts('internal-communication-of-system-updates-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Internal Communication of System Updates - Evidence Explanation - Example Company</h3>
...
export default InternalCommunicationOfSystemUpdatesEvidencePage;
