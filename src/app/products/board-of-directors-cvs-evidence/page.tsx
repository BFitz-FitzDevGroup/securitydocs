...
const BoardOfDirectorsCvsEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('board-of-directors-cvs-evidence');
  const relatedProducts = getRelatedProducts('board-of-directors-cvs-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Board of Directors CVs - Evidence Explanation - Example Company</h3>
...
export default BoardOfDirectorsCvsEvidencePage;
