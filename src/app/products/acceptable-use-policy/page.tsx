          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                Employee acceptable use policy defining appropriate use of company systems, data, and resources. Includes enterprise, SMB, implementation workbook, and quick reference guide.
              </p>
            </div>
