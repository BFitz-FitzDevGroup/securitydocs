...
const PenetrationTestRemediationEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('penetration-test-remediation-evidence');
  const relatedProducts = getRelatedProducts('penetration-test-remediation-evidence');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC3.4:</strong> COSO Principle 12: The entity deploys risk management processes</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC4.1:</strong> COSO Principle 13: The entity monitors its environment to assess the quality of internal controls</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Penetration Test Remediation - Evidence Explanation - Example Company</h3>
...
export default PenetrationTestRemediationEvidencePage;
