...
const PubliclyAvailableChangeLogsEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('publicly-available-change-logs-evidence');
  const relatedProducts = getRelatedProducts('publicly-available-change-logs-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Publicly Available Change Logs - Evidence Explanation - Example Company</h3>
                      ...
                      <div className="bg-white rounded p-4 border border-slate-200">
                        <ul className="space-y-2 text-slate-700 text-sm">
                          <li className="flex items-start">
                            ...
                            <span>Change approval process</span>
                          </li>
                          <li className="flex items-start">
                            <span className="w-2 h-2 bg-slate-400 rounded-full mr-3 mt-2 flex-shrink-0"></span>
...
export default PubliclyAvailableChangeLogsEvidencePage;
