...
const CybersecurityInsurancePolicyEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('cybersecurity-insurance-policy-evidence');
  const relatedProducts = getRelatedProducts('cybersecurity-insurance-policy-evidence');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC9.1:</strong> The entity identifies, selects, and assesses risks affecting availability objectives</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Cybersecurity Insurance Policy - Evidence Explanation - Example Company</h3>
...
export default CybersecurityInsurancePolicyEvidencePage;
