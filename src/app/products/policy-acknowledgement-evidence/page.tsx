...
const PolicyAcknowledgementEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('policy-acknowledgement-evidence');
  const relatedProducts = getRelatedProducts('policy-acknowledgement-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Policy Acknowledgement - Evidence Explanation - Example Company</h3>
...
export default PolicyAcknowledgementEvidencePage;
