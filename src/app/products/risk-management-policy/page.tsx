...
const RiskManagementPolicyPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('risk-management-policy');
  const relatedProducts = getRelatedProducts('risk-management-policy');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC3.1:</strong> COSO Principle 9: The entity identifies and assesses changes that could significantly impact the system</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Risk Management Policy - Example Company</h3>
...
export default RiskManagementPolicyPage;
