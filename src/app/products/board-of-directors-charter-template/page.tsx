...
const BoardOfDirectorsCharterTemplatePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('board-of-directors-charter-template');
  const relatedProducts = getRelatedProducts('board-of-directors-charter-template');
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC1.3:</strong> COSO Principle 3: Management establishes structures, reporting lines, and authorities</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Board of Directors Charter Template - Example Company</h3>
...
export default BoardOfDirectorsCharterTemplatePage;
