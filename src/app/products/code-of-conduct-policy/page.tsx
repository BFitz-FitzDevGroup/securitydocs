...
const CodeOfConductPolicyPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('code-of-conduct-policy');
  const relatedProducts = getRelatedProducts('code-of-conduct-policy');
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>CC1.1:</strong> COSO Principle 1: The entity demonstrates a commitment to integrity and ethical values</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC1.2:</strong> COSO Principle 2: The board of directors demonstrates independence and oversight</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Code of Conduct Policy - Example Company</h3>
...
export default CodeOfConductPolicyPage;
