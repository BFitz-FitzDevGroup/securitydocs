...
const AccessReviewCompletedPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('access-review-completed');
  const relatedProducts = getRelatedProducts('access-review-completed');
            ...
            <div className="mb-8">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed">
                  Understanding what auditors expect for this evidence requirement is crucial for SOC 2 success. This Access Review Completed - Evidence Explanation clarifies exactly what documentation you need and how to present it effectively. Access control is one of the most scrutinized areas in SOC 2 audits, covering critical Trust Service Criteria around user authentication, authorization, and access reviews. Common audit findings include improper access provisioning, lack of regular access reviews, and inadequate documentation of access changes. This template addresses these common pitfalls with clear procedures for user onboarding, access modifications, and termination processes. Whether you're implementing multi-factor authentication requirements, establishing role-based access controls, or conducting quarterly access reviews, this comprehensive template provides the framework auditors expect to see. This evidence explanation clarifies exactly what auditors are looking for, common mistakes to avoid, and best practices for presenting this evidence during your SOC 2 audit. It's designed to demystify audit requirements and give you confidence in your compliance preparation.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC6.4:</strong> The entity restricts physical access to facilities and protected information</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Access Review Completed - Evidence Explanation - Example Company</h3>
...
export default AccessReviewCompletedPage;
