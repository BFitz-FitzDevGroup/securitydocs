...
const SampleJobDescriptionsForKeySecurityRolesDocumentPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('sample-job-descriptions-for-key-security-roles-document');
  const relatedProducts = getRelatedProducts('sample-job-descriptions-for-key-security-roles-document');
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li className="flex items-start">
                        <Check className="w-4 h-4 text-blue-600 mr-2 mt-1 flex-shrink-0" />
                        <span><strong>CC2.2:</strong> COSO Principle 7: The entity identifies and analyzes risk</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Sample Job Descriptions for Key Security Roles - Example Company</h3>
...
export default SampleJobDescriptionsForKeySecurityRolesDocumentPage;
