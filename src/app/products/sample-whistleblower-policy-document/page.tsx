...
const SampleWhistleblowerPolicyDocumentPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('sample-whistleblower-policy-document');
  const relatedProducts = getRelatedProducts('sample-whistleblower-policy-document');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Sample Whistleblower Policy - Example Company</h3>
...
export default SampleWhistleblowerPolicyDocumentPage;
