...
const SampleBusinessContinuityPlanPage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('sample-business-continuity-plan');
  const relatedProducts = getRelatedProducts('sample-business-continuity-plan');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Sample Business Continuity Plan - Example Company</h3>
...
export default SampleBusinessContinuityPlanPage;
