...
const ChangeRequestFormPage = () => {
  ...
  // Get product data
  const product = getProduct('change-request-form');
  const relatedProducts = getRelatedProducts('change-request-form');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Change Request Form - Example Company</h3>
