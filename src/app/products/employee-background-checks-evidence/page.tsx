...
const EmployeeBackgroundChecksEvidencePage = () => {
  const [showFullContent, setShowFullContent] = React.useState(false);

  // Get product data
  const product = getProduct('employee-background-checks-evidence');
  const relatedProducts = getRelatedProducts('employee-background-checks-evidence');
            ...
            <div className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-blue-500">
                <div className="prose prose-slate max-w-none">
                  <h3 className="text-lg font-semibold mb-3">Employee Background Checks - Evidence Explanation - Example Company</h3>
...
export default EmployeeBackgroundChecksEvidencePage;
