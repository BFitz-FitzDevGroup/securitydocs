...
excerpt: "Compare SOC 2 Type I and Type II reports side-by-side. Learn the cost, timeline, and scope differences to pick the right path for your company."
date: "2025-11-04"
  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        ...
        <th className="text-left py-3 px-4 font-semibold">Type I</th>
        <th className="text-left py-3 px-4 font-semibold">Type II</th>
      </tr>
    </thead>
    <tbody>
