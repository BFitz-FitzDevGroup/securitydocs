  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        <th className="text-left py-3 px-4 font-semibold">Likelihood / Impact</th>
        <th className="text-left py-3 px-4 font-semibold">Negligible (1)</th>
        <th className="text-left py-3 px-4 font-semibold">Minor (2)</th>
        <th className="text-left py-3 px-4 font-semibold">Moderate (3)</th>
        <th className="text-left py-3 px-4 font-semibold">Major (4)</th>
        <th className="text-left py-3 px-4 font-semibold">Catastrophic (5)</th>
      </tr>
    </thead>
    <tbody>
