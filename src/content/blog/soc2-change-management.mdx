  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        <th className="text-left py-3 px-4 font-semibold">Change Type</th>
        ...
        <th className="text-left py-3 px-4 font-semibold">Approval Needed</th>
        <th className="text-left py-3 px-4 font-semibold">Rollback Plan</th>
      </tr>
    </thead>
    <tbody>
...
<div className="overflow-x-auto my-8">
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        <th className="text-left py-3 px-4 font-semibold">Change Category</th>
        <th className="text-left py-3 px-4 font-semibold">Examples</th>
        <th className="text-left py-3 px-4 font-semibold">Risk Level</th>
        <th className="text-left py-3 px-4 font-semibold">Approval Required</th>
        <th className="text-left py-3 px-4 font-semibold">Testing Required</th>
      </tr>
    </thead>
    <tbody>
  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        ...
        <th className="text-left py-3 px-4 font-semibold">Testing</th>
        <th className="text-left py-3 px-4 font-semibold">Deploy Log</th>
