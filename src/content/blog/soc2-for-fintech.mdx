  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        <th className="text-left py-3 px-4 font-semibold">Risk Area</th>
        <th className="text-left py-3 px-4 font-semibold">Primary TSC</th>
        <th className="text-left py-3 px-4 font-semibold">Secondary TSC</th>
...
<div className="overflow-x-auto my-8">
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="bg-gray-100 border-b-2">
        <th className="text-left py-3 px-4 font-semibold">Control Description</th>
        ...
        <th className="text-left py-3 px-4 font-semibold">Single Implementation</th>
      </tr>
    </thead>
    <tbody>
      <tr className="odd:bg-white even:bg-gray-50 border-b">
